...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic.get('n_correct_dogs')/results_stats_dic.get('n_dogs_img'))* 100.0
    ...
    if results_stats_dic['n_notdogs_img'] > 0:
        results_stats_dic['pct_correct_notdogs'] = 100.0 * (results_stats_dic.get('n_correct_notdogs') /results_stats_dic.get('n_notdogs_img'))
    else:
